...
from zakaz.views import view_order_pages, view_change_order_status, view_order_cadastral, view_order
...
urlpatterns = [
    ...
    # path('customer_home/', view_customer_home, name='customer_home')
]
